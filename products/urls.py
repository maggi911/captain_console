...
urlpatterns = [
    ...
    path('consoles/sort_by_price', views.sort_consoles_by_price, name="sort-games-by-price"),
    path('games/sort_by_name', views.sort_games_by_name, name="sort-games-by-name"),
    path('consoles/sort_by_name', views.sort_consoles_by_name, name="sort-games-by-name"),
